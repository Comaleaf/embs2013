...
# Project:C:\temp\lt696-fpga\system.xmp
#
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(XPS_HDL_LANG) -intstyle $(INTSTYLE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_SIM_FILE_ARGS) -msg __xps/ise/xmsgprops.lst -s isim -X C:/temp/lt696-fpga/
...
implementation/system_handelc_0_wrapper.ngc \
implementation/system_fsltomb_wrapper.ngc \
implementation/system_fslfrommb_wrapper.ngc \
